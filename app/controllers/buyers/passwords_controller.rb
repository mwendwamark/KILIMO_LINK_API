module Buyers
  class PasswordsController < Devise::PasswordsController
    ...
    # POST /buyers/password (forgot password)
    def create
      ...
      unless user.buyer?
        return render json: { 
          success: false,
          error: "This email is not registered as a buyer. Please use the correct portal for your account type." 
        }, status: :forbidden
      end
    ...
    # PUT /buyers/password (reset password with token)
    def update
